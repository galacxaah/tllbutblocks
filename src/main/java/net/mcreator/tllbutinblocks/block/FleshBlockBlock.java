...
import net.mcreator.tllbutinblocks.procedures.Flesh_Update_TickProcedure;
...
public class FleshBlockBlock extends TllButInBlocksModElements.ModElement {
	@ObjectHolder("tll_but_in_blocks:flesh_block")
	public static final Block block = null;
	public FleshBlockBlock(TllButInBlocksModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Flesh_Update_TickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
