...
public class BrainwormBlock extends TllButInBlocksModElements.ModElement {
	@ObjectHolder("tll_but_in_blocks:brainworm")
	public static final Block block = null;
	public BrainwormBlock(TllButInBlocksModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SLIME).hardnessAndResistance(1f, 4f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.AXE).slipperiness(0.5f));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("brainworm");
		}
