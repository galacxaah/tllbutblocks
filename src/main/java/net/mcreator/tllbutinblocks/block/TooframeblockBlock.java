...
public class TooframeblockBlock extends TllButInBlocksModElements.ModElement {
	@ObjectHolder("tll_but_in_blocks:tooframeblock")
	public static final Block block = null;
	public TooframeblockBlock(TllButInBlocksModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WET_GRASS).hardnessAndResistance(1.5f, 15f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.AXE).notSolid());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("tooframeblock");
		}
