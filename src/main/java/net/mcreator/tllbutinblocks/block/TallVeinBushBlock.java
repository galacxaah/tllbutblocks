...
import net.mcreator.tllbutinblocks.procedures.TallVeinBushAdditionalGenerationConditionProcedure;
...
public class TallVeinBushBlock extends TllButInBlocksModElements.ModElement {
	@ObjectHolder("tll_but_in_blocks:tall_vein_bush")
	public static final Block block = null;
	public TallVeinBushBlock(TllButInBlocksModElements instance) {
		super(instance, 44);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new TallBlockItem(block, new Item.Properties().group(TLLItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		RandomPatchFeature feature = new RandomPatchFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				if (!TallVeinBushAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
					return false;
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("tall_vein_bush");
		}
