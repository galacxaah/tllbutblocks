...
public class ShootytestItem extends TllButInBlocksModElements.ModElement {
	@ObjectHolder("tll_but_in_blocks:shootytest")
	public static final Item block = null;
	@ObjectHolder("tll_but_in_blocks:entitybulletshootytest")
	public static final EntityType arrow = null;
	public ShootytestItem(TllButInBlocksModElements instance) {
		super(instance, 63);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletshootytest").setRegistryName("entitybulletshootytest"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(TllItemsItemGroup.tab).maxDamage(100));
			setRegistryName("shootytest");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(WhitebloodcellitemItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(WhitebloodcellitemItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(WhitebloodcellitemItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(WhitebloodcellitemItem.block, (int) (1));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("tll_but_in_blocks:textures/white_blood_cell_texture.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelWhiteBloodCell();
