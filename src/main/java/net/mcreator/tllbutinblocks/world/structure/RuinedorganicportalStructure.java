...
public class RuinedorganicportalStructure extends TllButInBlocksModElements.ModElement {
	public RuinedorganicportalStructure(TllButInBlocksModElements instance) {
		super(instance, 14);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 600) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("tll_but_in_blocks", "ruined_organic_portal"));
						if (template == null)
							return false;
