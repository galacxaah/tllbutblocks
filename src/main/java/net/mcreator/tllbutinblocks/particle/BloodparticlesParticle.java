...
package net.mcreator.tllbutinblocks.particle;
...
public class BloodparticlesParticle extends TllButInBlocksModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public BloodparticlesParticle(TllButInBlocksModElements instance) {
		super(instance, 73);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("bloodparticles"));
	}
	...
	private static class CustomParticle extends SpriteTexturedParticle {
		...
		protected CustomParticle(World world, double x, double y, double z, double vx, double vy, double vz, IAnimatedSprite spriteSet) {
			...
			this.maxAge = (int) Math.max(1, 20 + (this.rand.nextInt(52) - 26));
